...
const ClassPoll: React.FC = () => {
  ...
  useEffect(() => {
    if (isMetaMaskConnected && currentPoll) {
      const interval = setInterval(fetchVoteCounts, 5000);
      return () => clearInterval(interval);
    }
  }, [isMetaMaskConnected, currentPoll]);
            ...
            {!isConnected ? (
              <div className="w-full text-center">
                <InfoAlert
                  ...
                  className="mb-4"
                >
                  Connect your OCID to participate in classroom polls.
                </InfoAlert>
                <Link href="/user?redirectTo=/v1/class-poll-dapp">
                  <LoginButton />
                </Link>
              </div>
            ) : (
