...
export default function StudyGroup() {
  ...
  useEffect(() => {
    ...
    if (isMetaMaskConnected && contract) {
      ...
      <div className="flex flex-col items-center justify-center flex-grow w-full mt-24 px-4">
        <Card className="w-full max-w-2xl p-8 shadow-lg">
          ...
          <CardContent className="flex flex-col items-center mt-4 space-y-6">
            {!isConnected ? (
              <div className="w-full text-center">
                <InfoAlert
                  ...
                  className="mb-4"
                >
                  Connect your OCID to join the study group chat.
                </InfoAlert>
                <Link href="/user?redirectTo=/v1/student-group-dapp">
                  <LoginButton />
                </Link>
              </div>
            ) : (
            ...
            {isConnected && isMetaMaskConnected && !isMember && (
              <Button
