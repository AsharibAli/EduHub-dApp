...
export default function Component() {
  ...
  useEffect(() => {
    ...
    if (isMetaMaskConnected && isEducator && contract) {
      interval = setInterval(fetchSubmissions, 5000);
    }
    return () => clearInterval(interval);
  }, [isMetaMaskConnected, isEducator, contract]);
            ...
            {!isConnected ? (
              <div className="w-full text-center">
                <InfoAlert
                  ...
                  className="mb-4"
                >
                  Connect your OCID to submit assignments.
                </InfoAlert>
                <Link href="/user?redirectTo=/v1/assignment-submission-dapp">
                  <LoginButton />
                </Link>
              </div>
            ) : (
