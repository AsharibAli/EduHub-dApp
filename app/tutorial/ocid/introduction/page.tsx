    ...
    <div>
      ...
      <div className="prose max-w-none">
        ...
        <p className="text-gray-700 mb-4">
          ...
          As part of Open Campus&apos;s blockchain protocol, it issues Decentralized Identifiers (DIDs) in the form of SBTs.
        </p>
        ...
        <p className="text-gray-700 mb-4">
          The OCID Connect SDK makes it simple to integrate Open Campus&apos;s secure authentication system into your application. 
